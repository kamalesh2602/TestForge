...
- **Multi-language code execution**: Run Python, Java, and JavaScript directly in the browser workbench.
...
- **Code formatting**: Auto-format Python code (via Black) and JavaScript/Java code (via Prettier).
